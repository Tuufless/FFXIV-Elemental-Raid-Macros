...
<table>
  <tr>
    <td>
      <p>Not really. Twintania has more max HP than Nael, but the two 
      bosses start the phase with roughly the same HP (Nael starts with 
      negligibly more HP than Twintania), which is why Nael's starting HP% is 
      higher</p>
    </td>
  </tr>
</table>
