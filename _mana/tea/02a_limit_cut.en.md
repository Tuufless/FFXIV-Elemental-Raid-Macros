...
permalink: /mana/tea/02a_limit_cut/
---
...
<table>
  <tr>
    <td>
      <p>Limit Cut is a mechanic from A11S where all players get numbered from 
      1 to 8. The following then happens:</p>
      <ol>
        <li>Cruise Chaser <b>spawns behind</b> the first player (which will be
        an odd number) based on where that player is facing.</li>
        <li>Cruise Chaser cleaves the first player in a cone AoE.</li>
        <li>Cruise Chaser dashes at the next player (which will be an even 
        number) in a line AoE.</li>
      </ol>
      <p>This process repeats (cleave odd, dash even) until all eight numbers 
      have been resolved. If a number is missing, Cruise Chaser picks a random
      target instead.</p>
      <p>Getting hit by Cruise Chaser will give you a <em>Magic Vulnerability</em>
      debuff, so you cannot get hit a second time.</p>
      <p>In addition, <b>you will be knocked away from Cruise Chaser if you are
      not facing Cruise Chaser when it hits you.</b></p>
      <p>Because Cruise Chaser always spawns behind the odd-numbered players,
      the odd-numbered players will <em>always</em> be knocked forward, unless
...
However, it is the harder of the two to learn, especially for players new to
TEA.
