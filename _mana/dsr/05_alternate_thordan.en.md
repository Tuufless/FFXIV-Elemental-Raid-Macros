...
has_children: false
has_toc: false
permalink: /mana/dsr/05_alternate_thordan/
---
...
{% include youtube.html id="m94t8pli9DU" %}
    ...
    <td width="50%">
      ...
      <ul>
        ...
        <li>
          ...
          away from the NE and SE "shurikens"), <em>roughly</em> in the
          following order:</p>
          <ul>
            <li><b>North:</b> MT ST D1 D2 D3 D4 H1 H2 <b>:South</b></li>
          </ul>
        </li>
      </ul>
    </td>
...
{% include youtube.html id="eCixBQKH6w4" %}

Mana does the "Komazou" strat, which splits the Dooms 2-2.
  ...
  <tr>
    <td width="50%">
      ...
      <p style="text-align:center">
        <b>West:</b> MT ST D1 D2 D3 D4 H1 H2 <b>:East</b>
      </p>
      <p>Thordan and the Dragon Eye will also spawn at two (inter)cardinal
      positions, either 135 degrees or 180 degrees apart.</p>
    </td>
    <td><img src="{{site.baseurl}}/images/ultimates/dsr_mana/05/death_of_the_heavens_01.jpg"></td>
  </tr>
  <tr>
    <td>
      <p><b>2.</b> Four random players will be targeted with Doom.</p>
      <ul>
        <li>Doomed players step away from Ser Guerrique to make a line of four.</li>
        <li>Non-Doomed players step towards Ser Guerrique to make a line of
        four.</li>
      </ul>
      <p>This step forward/back is to help the players in the center identify
      their order within each Doom vs. non-Doom group.</p>
    </td>
    <td><img src="{{site.baseurl}}/images/ultimates/dsr_mana/05/death_of_the_heavens_02.jpg"></td>
  </tr>
  <tr>
    <td>
    ...
    <td><img src="{{site.baseurl}}/images/ultimates/dsr_mana/05/death_of_the_heavens_03.jpg"></td>
  </tr>
  <tr>
    <td>
    ...
    <td><img src="{{site.baseurl}}/images/ultimates/dsr_mana/05/death_of_the_heavens_04.jpg"></td>
  </tr>
  <tr>
    <td>
      ...
      <ul>
        ...
        <li>The SW Doom player takes up position towards the NW, and the SE
        Doom player takes up position towards the NE.</li>
      </ul>
      <p><b>Non-Doomed players:</b></p>
      <ul>
        <li>Line up west-to-east a little south of center.</li>
      </ul>
    </td>
    <td><img src="{{site.baseurl}}/images/ultimates/dsr_mana/05/death_of_the_heavens_05.jpg"></td>
  </tr>
  <tr>
    <td>
    ...
    <td><img src="{{site.baseurl}}/images/ultimates/dsr_mana/05/death_of_the_heavens_06.jpg"></td>
  </tr>
  <tr>
    <td>
    ...
    <td><img src="{{site.baseurl}}/images/ultimates/dsr_mana/05/death_of_the_heavens_07.jpg"></td>
  </tr>
  <tr>
    <td>
    ...
    <td><img src="{{site.baseurl}}/images/ultimates/dsr_mana/05/death_of_the_heavens_08.jpg"></td>
  </tr>
</table>
...
A caster LB2 on the North Meteor will destroy the NW, N, and NE Meteor Circles;
if there are no casters alive, a ranged LB2 will also suffice.
...
<table>
  <tr>
    <td>
      <p>A caster LB2 can target a Meteor and hit the two adjacent Meteors. A
      ranged LB2 will need to be properly aimed to hit three Meteors.</p>
    </td>
  </tr>
</table>
</details>
...
<table>
  <tr>
    <td>
      <p>At the end of the next phase with Nidhogg and Hraesvelgr, Nidhogg's
      eyes threaten to take over Estinien again.</p>
      <p>If Thordan was spared at the end of this phase, this is where Thordan
      ...
      <blockquote class="twitter-tweet">
        ...
        &mdash; たかぱすと (@takapast)
        <a href="https://twitter.com/takapast/status/1522008634158649345?ref_src=twsrc%5Etfw">
        May 5, 2022</a>
      </blockquote>
...
<details markdown=block>
<summary>
  <b>[Death of the Heavens]</b> How did two players clip their <em>Heavensflame</em>
  AoE despite getting knocked back correctly?
</summary>
<table>
  <tr>
    <td width="50%">
